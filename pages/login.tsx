import { Box, Button, FormControl, Grid, InputAdornment, Typography } from "@mui/material"
      ...
      >
        ...
        >
          <Box sx={{ width: "100%" }}>
            ...
            <Button sx={{ mt: 2, width: "100%" }} variant="outlined" type="submit">
              Login
            </Button>
          </Box>
          <Box sx={{ width: "100%" }}>
              ...
              <Grid container rowSpacing={2} columnSpacing={{ xs: 2, sm: 2, md: 3 }}>
                <Grid item xs={6} md={6} lg={6}>
                  <Button sx={{ width: "100%" }} variant="outlined">
                    <Lottie style={{ height: "30px", width: "30px" }} animationData={google} loop />
